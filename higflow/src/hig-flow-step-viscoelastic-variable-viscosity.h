...
void higflow_explicit_euler_intermediate_velocity_viscoelastic_variable_viscosity(higflow_solver *ns, distributed_property *dpu[DIM], distributed_property *pdustar[DIM]); 
...
void higflow_semi_implicit_bdf2_intermediate_velocity_viscoelastic_variable_viscosity(higflow_solver *ns); 
...
// Computing the Kernel Tensor with variable viscosity
void higflow_compute_kernel_tensor_variable_viscosity(higflow_solver *ns);

// Computing the Polymeric Tensor with variable viscosity
