// Adaptive height function: choose the column direction and extent per cell instead
// of fixing them, so the stencil still spans the interface where the standard method
// in hig-flow-vof-hf-padrao.h would produce a column that misses it.
//
