...
typedef struct vevv_controllers
{
    ...
    // Viscoelastic convective discretization type
    int convecdiscrtype;
    // Discretization type for the viscosity evolution equation (only for the BMP model)
    int viscdiscrtype;
    // Convective discretization type for the viscosity evolution equation (only for the BMP model)
    int viscconvecdiscrtype;
} vevv_controllers;
