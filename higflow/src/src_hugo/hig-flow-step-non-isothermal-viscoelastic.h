...
#ifndef HIG_FLOW_STEP_NON_ISOTHERMAL_VISCOELASTIC
#define HIG_FLOW_STEP_NON_ISOTHERMAL_VISCOELASTIC
...
void higflow_explicit_euler_intermediate_velocity_viscoelastic_non_isothermal_flows(higflow_solver *ns, distributed_property *dpu[DIM], distributed_property *pdustar[DIM]); 
...
// Calculate f(T) using theVogel-Tamman-Fulcher (VTF) model
...
//Solving the energy equation for non-isothermal flows using the Euler explicit method
void higflow_explicit_euler_energy_equation(higflow_solver *ns);

//Solving the energy equation for non-isothermal flows using the Euler implicit method
