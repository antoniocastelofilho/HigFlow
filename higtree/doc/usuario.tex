...
casos mais complexos. Cada tutorial é acompanhado de um código executável.Para compilá-los individualmente, basta usar o comando \texttt{make nome\_do\_tutorial} (sem o \texttt{.c}). Para compilar todos de uma só vez, usa-se \texttt{make all}.
