...
# The reader lives in tools/higflow_vtk.py, shared with the verification suite
# so the two cannot disagree about what a field means.
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), ".."))
from higflow_vtk import Grid, read_vtk, latest_vtk  # noqa: E402
